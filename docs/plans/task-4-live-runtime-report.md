...
Task E supersedes this report's former Provider bootstrap boundary. The live
fixture remains historical evidence for the runtime harness; current Provider
operations consume the activated Nix Host profile and do not upload or install
`sub2api-host`. Its exact-SHA results, if any, do not establish the Task E
release or post-release lock gate.

...
func legacyCode2Aliases(layout SiteLayout, oldName string) []pulumi.Alias {
	if layout.SiteID != "code2" || layout.ComposeProject != "sub2api" || layout.RuntimeRoot != "runtime" {
		return nil
	}
...
func siteEnvironment(siteID string, spec SiteSpec, layout SiteLayout, runtime, appEnv pulumi.StringInput, configuredSiteIDs, originIP string) pulumi.StringMap {
	return pulumi.StringMap{
		...
		"SITE_RUNTIME_ENV_PATH": pulumi.String(layout.RuntimeEnvPath), "SITE_APP_ENV_PATH": pulumi.String(layout.AppEnvPath), "SITE_DEPLOY_STATE_PATH": pulumi.String(layout.DeployStatePath),
		...
		"REDIS_MODE": pulumi.String(spec.Redis.Mode), "RUNTIME_JSON": runtime, "APP_ENV_JSON": appEnv,
		"APP_ENV_CONFIGURED":  pulumi.String("false"),

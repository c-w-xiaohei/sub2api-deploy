...
func reconcileNeonEndpointSettings(ctx *pulumi.Context, site pulumi.Resource, siteID string, project *neonProject, apiKey pulumi.StringInput, region string, compute NeonComputeSpec, preflight, regionValidation pulumi.Resource, endpointChecksum string) (*local.Command, error) {
	...
	return newCommand(ctx, "site-"+siteID+"-neon-endpoint-settings", "bash scripts/node-env.sh npx --no-install tsx scripts/reconcile-neon-endpoint.ts", environment, triggers, site, preflight, project, regionValidation)
}
